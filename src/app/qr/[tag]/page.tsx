...
const STATUS_CFG = {
  ...
  interditado: {
    label: "INTERDITADO",
    msg: "ANDAIME INTERDITADO. Uso estritamente proibido. Risco de acidente.",
    bg: "bg-red-800",
  ...
  desmontado: {
    label: "DESMONTADO",
    msg: "Este andaime foi desmontado e esta fora de operacao.",
    bg: "bg-slate-500",
  ...
  return (
    ...
    >
      <div className="w-full max-w-sm flex flex-col gap-3">
        ...
        <div
          className={"rounded-2xl overflow-hidden shadow-2xl ring-1 " + cfg.ring}
        ...
        >
          <div className={"px-6 py-5 flex items-center justify-between " + cfg.bg}>
            ...
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center bg-white/20 ring-2 ring-white/40 backdrop-blur-sm">
              <StatusIcon className="w-9 h-9 text-white drop-shadow" />
            </div>
          </div>
          ...
          <div className="px-6 py-2">
            <InfoRow icon={MapPin} label="Localizacao" value={scaffold.location} />
            <InfoRow icon={User} label="Responsavel" value={scaffold.responsible} />
            {scaffold.company && (
              <InfoRow icon={Building2} label="Empresa" value={scaffold.company} />
            )}
            {validadeFormatted && (
              <InfoRow
                icon={CalendarDays}
              ...
              <div className="flex items-start justify-between gap-2">
                ...
                <span
                  className={
                    ...
                    (RESULT_STYLE[lastInspection.result]?.color ?? "text-white/60")
                  }
                >
        ...
        <div className="text-center pt-1 pb-2">
          <p className="text-[9px] text-white/20">
            Gerado por AndCheck - Plataforma de Gestao do Ciclo de Vida de Andaimes
          </p>
